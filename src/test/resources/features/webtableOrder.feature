...
#Note: Follow POM
##1- Parameterize scenario has finished
##2- Scenario Outline after. it is down>>>>
    # 1st we need to change  Scenario Template #2nd one by one write rows#write general name
